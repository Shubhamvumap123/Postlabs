...
export default function Footer() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // SECURITY: Removed client-side Mailchimp API call to prevent API key exposure.
      // In a real application, this should be proxied through a secure backend endpoint.
      // Simulating a successful "Demo Mode" subscription per repository instructions.
