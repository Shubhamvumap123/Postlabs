...
export default function Footer() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Removed unsafe client-side API call to Mailchimp.
    // Client-side API keys are visible to users and can be abused.
    // In a real app, this should submit to a backend proxy.

    // Simulate API call for demo purposes
    await new Promise((resolve) => setTimeout(resolve, 1000));

    toast.success(`Subscribed to newsletter (Demo)`, {
      description: `We've registered ${email} for updates.`,
    });
