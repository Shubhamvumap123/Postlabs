...
export default function Footer() {
  ...
  try {
    // 🛡️ SECURITY: Client-side API calls to services requiring private keys are strictly forbidden.
    // They must be proxied via a backend to avoid exposing API keys in the frontend bundle.
    // Simulating Demo Mode here.
