            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-zinc-800">
                ...
                <button
                  ...
                  className="p-2 text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-purple-500 outline-none"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
