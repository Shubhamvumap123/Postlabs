...
const Navigation = () => {
  ...
  // ⚡ Bolt: Replaced independent DOM scroll listener with framer-motion's useScroll and useMotionValueEvent to leverage centralized read/write batching and prevent layout thrashing
