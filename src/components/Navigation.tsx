...
const Navigation = () => {
  ...
  // PERFORMANCE: Replaced manual requestAnimationFrame scroll event listener with Framer Motion's useScroll and useMotionValueEvent to achieve centralized read/write batching and prevent layout thrashing.
