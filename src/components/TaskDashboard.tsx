              ...
              {filteredTasks.map((task) => (
                ...
                >
                  <button
                    ...
                    className="flex-shrink-0 text-zinc-500 hover:text-purple-400 transition-colors focus-visible:ring-2 focus-visible:ring-purple-500 outline-none rounded"
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                    {task.status !== 'Archived' && (
                      <button
                        ...
                        className="p-1.5 text-zinc-500 hover:text-zinc-300 rounded hover:bg-zinc-800 focus-visible:ring-2 focus-visible:ring-purple-500 outline-none"
                        title="Archive"
                        aria-label="Archive"
                      >
                    ...
                    <button
                      ...
                      className="p-1.5 text-zinc-500 hover:text-red-400 rounded hover:bg-zinc-800 focus-visible:ring-2 focus-visible:ring-purple-500 outline-none"
                      title="Delete"
                      aria-label="Delete"
                    >
