...
export default function TaskDashboard() {
  ...
  // Memoize filtered tasks to prevent expensive O(N) recalculations on every render,
  // especially when typing in the "New Task" input which triggers frequent re-renders.
