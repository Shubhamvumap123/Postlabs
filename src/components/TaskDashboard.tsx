...
export default function TaskDashboard() {
  ...
  // Optimization: Memoize filtered tasks to prevent unnecessary recalculations on every render
  // This avoids running the O(n) filter logic when unrelated state (like input fields) changes
