    ...
    <div className="w-full max-w-2xl mx-auto p-4 sm:p-6 bg-zinc-900 rounded-xl border border-zinc-800 text-zinc-100 shadow-xl">
      ...
      >
        <form onSubmit={addTask} className="space-y-4">
          ...
          <div className="space-y-2">
            <label id="category-group-label" className="text-sm font-medium text-zinc-300">
              Category
            </label>
            <div className="flex gap-2" role="group" aria-labelledby="category-group-label">
              {filters.map(filter => (
                <button
                  key={filter.id}
                  type="button"
      ...
      {/* Bottom Filter Chips */}
      <div className="mt-8">
        <h4 id="agents-group-label" className="text-sm font-medium text-zinc-400 mb-3">Skill-based agents</h4>
        <div className="flex flex-wrap gap-3" role="group" aria-labelledby="agents-group-label">
