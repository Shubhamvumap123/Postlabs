...
const Settings = () => {
  // PERFORMANCE: Use synchronous lazy initialization for localStorage to prevent extra render cycles
  const [name, setName] = useState(() => globalThis.localStorage.getItem("userName") || "");
            ...
            <section className="bg-card border border-border rounded-xl p-6 shadow-sm">
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {/* SECURITY: Added input length limits to prevent localStorage DoS */}
                  <Input
                    id="name"
                    name="name"
                    autoComplete="name"
              ...
              <div className="grid grid-cols-3 gap-4" role="group" aria-label="Theme preference">
                {['light', 'dark', 'system'].map((t) => (
                  <button
                    ...
                    aria-pressed={theme === t}
                    className={`
                      flex flex-col items-center gap-2 p-4 rounded-lg border transition-all outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2
                      ${theme === t
