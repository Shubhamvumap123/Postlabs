...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    // SECURITY: Use textContent instead of innerHTML to prevent DOM-based XSS vulnerabilities
    style.textContent = `
        ...
        <div className="col-span-2 flex flex-col gap-4 px-5 py-5">
          ...
          <form className="flex gap-2 max-w-md" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="min-w-[56px] inline-flex items-center justify-center bg-white text-black rounded-md font-medium outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
