...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    // SECURITY: Use textContent instead of innerHTML to prevent potential DOM-based XSS
    style.textContent = `
        ...
        <div className="col-span-2 flex flex-col gap-4 px-5 py-5">
          ...
          <form className="flex gap-2 max-w-md" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="inline-flex items-center justify-center min-w-[56px] px-5 bg-white text-black rounded-md font-medium outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
