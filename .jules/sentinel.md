...
## 2026-04-19 - Missing Input Length Limits
**Vulnerability:** User-facing inputs lacked maximum length constraints.
**Learning:** Client-side DoS or unbounded state/localStorage growth could occur from extremely large inputs.
**Prevention:** Ensure all user-facing HTML input and textarea fields have appropriate maxLength limits applied.
