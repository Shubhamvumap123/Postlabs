...
## 2026-04-22 - Optimize Text Animation Rendering
**Learning:** Generating arrays of span elements inside the render loop based on dynamic state causes unnecessary work and blocks the main thread during text animations.
