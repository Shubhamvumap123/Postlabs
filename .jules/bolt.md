...
## 2026-04-17 - About Text Animation Bottleneck
**Learning:** Generating arrays of spans inside the render loop based on dynamic state causes unnecessary work and main thread blocking.
