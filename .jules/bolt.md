...
## 2025-02-19 - Image Loading Strategy Optimization
**Learning:** Found a systemic anti-pattern where deeply nested below-the-fold images (e.g., in PrivacySection and CardSection) were missing lazy loading entirely, bloating the initial payload, while critical above-the-fold images were implicitly deferred by browser defaults, missing opportunities for earlier preloads.
