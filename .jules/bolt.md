...
## 2025-05-04 - React text animation memoization
**Learning:** Generating arrays of span elements inside the render loop based on dynamic state can block the main thread.
