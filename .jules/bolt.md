...
## 2025-02-18 - Text Animation Re-render Bottleneck
**Learning:** Generating arrays of span elements inside the render loop based on dynamic state for character-by-character animations causes main thread blocking.
