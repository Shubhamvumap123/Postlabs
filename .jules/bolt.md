...
## 2024-05-18 - Dynamic Span Generation Bottleneck
**Learning:** Generating arrays of span elements inside the render loop based on dynamic state blocks the main thread and causes unnecessary re-renders.
